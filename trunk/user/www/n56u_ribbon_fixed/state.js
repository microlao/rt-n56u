...
menuL1_title = new Array("", "<#menu1#>", "", "<#menu2#>", "", "<#menu4#>", "<#menu5_8#>", "<#menu5#>");
menuL1_link = new Array("", "index.asp", "", "vpnsrv.asp", "", "Main_TrafficMonitor_realtime.asp", "Advanced_System_Info.asp", "as.asp");
